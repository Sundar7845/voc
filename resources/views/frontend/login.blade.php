...
<main class="bg-[url('/images/background.jpg')] min-h-screen flex justify-center items-center">
        ...
        <div class="px-16 space-y-8 grow max-w-xl">
            <div class="flex flex-col gap-8 justify-center items-center">
                ...
                <div class="text-xl md:text-2xl text-center font-semibold uppercase text-[#FCFAF9] copperplate">JewelOne - VOC Form</div>
            </div>
            ...
            <div>
                <form>
                    <div class="relative mb-8">
                      ...
                      <div>
                        <button class="text-[#964A26] cursor-pointer bg-[#F2EDE4] block w-full uppercase h-12 rounded-md text-lg font-semibold">
                            Login
                        </button>
                      </div>
