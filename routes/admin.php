...
Route::group(['middleware' => ['auth']], function () {
    ...
    // Route::get('/customer/sales-report/{id}', [DashboardController::class, 'getSalesReportData']);
    Route::get('getfeedback/{id}', [DashboardController::class, 'getfeedback'])->name('getfeedback');
});
